...
ADD https://download.nextcloud.com/server/prereleases/nextcloud-20.0.2RC1.tar.bz2 /root/nextcloud.tar.bz2
ADD https://github.com/nextcloud/richdocuments/releases/download/v3.7.8/richdocuments.tar.gz /root/richdocuments.tar.gz
