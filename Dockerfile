...
ADD https://download.nextcloud.com/server/releases/nextcloud-17.0.1.tar.bz2 /root/nextcloud.tar.bz2
ADD https://github.com/nextcloud/richdocuments/releases/download/v3.4.5/richdocuments.tar.gz /root/richdocuments.tar.gz
ADD https://github.com/ONLYOFFICE/onlyoffice-nextcloud/releases/download/v3.0.2/onlyoffice.tar.gz /root/onlyoffice.tar.gz
