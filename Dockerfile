...
ADD https://download.nextcloud.com/server/releases/nextcloud-26.0.10.tar.bz2 /root/nextcloud.tar.bz2
ADD https://github.com/nextcloud-releases/richdocuments/releases/download/v8.0.6/richdocuments-v8.0.6.tar.gz /root/richdocuments.tar.gz
ADD https://github.com/ONLYOFFICE/onlyoffice-nextcloud/releases/download/v7.9.4/onlyoffice.tar.gz /root/onlyoffice.tar.gz
