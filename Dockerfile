...
ADD https://download.nextcloud.com/server/prereleases/nextcloud-21.0.3rc1.tar.bz2 /root/nextcloud.tar.bz2
ADD https://github.com/nextcloud/richdocuments/releases/download/v4.1.2/richdocuments.tar.gz /root/richdocuments.tar.gz
ADD https://github.com/ONLYOFFICE/onlyoffice-nextcloud/releases/download/v7.0.2/onlyoffice.tar.gz /root/onlyoffice.tar.gz
