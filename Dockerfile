...
ADD https://download.nextcloud.com/server/releases/nextcloud-16.0.6.tar.bz2 /root/nextcloud.tar.bz2
ADD https://github.com/nextcloud/richdocuments/releases/download/v3.4.4/richdocuments.tar.gz /root/richdocuments.tar.gz
