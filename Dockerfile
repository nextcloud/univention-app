...
ADD https://download.nextcloud.com/server/prereleases/nextcloud-14.0.8RC2.tar.bz2 /root/nextcloud.tar.bz2
ADD https://github.com/nextcloud/richdocuments/releases/download/v3.2.1/richdocuments.tar.gz /root/richdocuments.tar.gz
